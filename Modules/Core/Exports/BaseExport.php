...
class BaseExport implements FromCollection, WithHeadings, WithTitle, WithEvents, WithChunkReading, WithStyles
{
   ...
   */
  protected $translation_file = 'lang';
  /**
   * @var string
   * header background
   */
  protected $header_background = '0066ff';
  /**
   * @var string
   * set border color
   */
  protected $border_color = '0066ff';
  /**
   * @var string .
   * font family
   */
  ...
  public function headings(): array
  {
    return collect($this->headings)->map(function ($value) {
      return trans("$this->translation_file.$value");
    })->toArray();
  }
...
//
      ...
      if (count($this->getCalculatedColumns()) > 0)
